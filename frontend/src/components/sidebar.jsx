...
const Sidebar = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      {/* Sidebar - Usamos 'relative' en desktop para que ocupe espacio real */}
      <aside className={`
      ...
      `}>
        ...
        <nav className="flex flex-col gap-3 w-full">
          <button className="bg-unam-gold text-sidebar-blue p-3 rounded-lg text-left font-bold flex items-center gap-3 shadow-lg">
            🏠 Inicio
          </button>
